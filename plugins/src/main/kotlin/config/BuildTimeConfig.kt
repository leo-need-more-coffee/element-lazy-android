...
object BuildTimeConfig {
    const val APPLICATION_ID = "io.element.lazy"
    const val APPLICATION_NAME = "Element Lazy"
    ...
    val METADATA_HOST_REVERSED: String? = "io.element.lazy"
    ...
    val BUG_REPORT_APP_NAME: String? = "Element Lazy"
